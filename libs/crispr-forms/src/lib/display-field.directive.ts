import { Directive, Input, ViewContainerRef, OnInit, ChangeDetectorRef, Type } from '@angular/core';
import { FormGroup } from '@angular/forms';
// eslint-disable-next-line @nrwl/nx/enforce-module-boundaries
import { ControlValue, CrisprDisplayFieldComponent } from '@tft/crispr-forms/utils';
